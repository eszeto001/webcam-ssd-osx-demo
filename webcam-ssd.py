...
# This was downloaded as python from the
# object_detction_tutorial.ipynb,
# then hacked.  The places that were hacked
# are marked HACK.

# HACK - Modify this to the localion of the tensorflow models/ directory
